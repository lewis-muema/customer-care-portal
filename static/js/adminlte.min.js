...
+(function(a) {
  function b(b) {
    return this.each(function() {
      ...
      let g = e.data(c);
      if (!g) {
        const h = a.extend({}, d, e.data(), typeof b === 'object' && b);
  ...
  const e = { data: '[data-widget="box-refresh"]' };
  var f = function(b, c) {
    if (
      ((this.element = b),
      (this.options = c),
  ...
  (function(a) {
    function b(b) {
      return this.each(function() {
        ...
        let f = e.data(c);
        if (!f) {
          const g = a.extend({}, d, e.data(), typeof b === 'object' && b);
    ...
    const f = { collapsed: 'collapsed-box' };
    const g = {
    ...
    (h.prototype.toggle = function() {
      ...
      (h.prototype.expand = function() {
        const b = a.Event(g.expanded);
        const c = a.Event(g.expanding);
        const d = this.options.collapseIcon;
        const h = this.options.expandIcon;
      ...
      (h.prototype.collapse = function() {
        const b = a.Event(g.collapsed);
        const c = a.Event(g.collapsing);
        const d = this.options.collapseIcon;
        const h = this.options.expandIcon;
        a(this.element)
          .children(`${e.header}, ${e.body}, ${e.footer}`)
      ...
      (h.prototype.remove = function() {
        const b = a.Event(g.removed);
        const c = a.Event(g.removing);
        a(this.element)
          .slideUp(
            this.options.animationSpeed,
            function() {
  ...
  (function(a) {
    ...
    const f = { open: 'control-sidebar-open', fixed: 'fixed' };
    const g = {
  ...
  (function(a) {
    function b(b) {
      return this.each(function() {
        const d = a(this);
        let e = d.data(c);
        e || d.data(c, (e = new f(d))), typeof b === 'string' && e.toggle(d);
      });
    }
    var c = 'lte.directchat';
    const d = { data: '[data-widget="chat-pane-toggle"]', box: '.direct-chat' };
    const e = { open: 'direct-chat-contacts-open' };
    var f = function(a) {
      this.element = a;
    };
  ...
  (function(a) {
    ...
    (h.prototype.init = function() {
      ...
      (h.prototype.toggle = function() {
        const b = a(window).width();
        let c = !a('body').hasClass(f.collapsed);
  ...
  (function(a) {
    ...
    const e = { data: '[data-widget="todo-list"]' };
    const f = { done: 'done' };
    var g = function(a, b) {
      (this.element = a), (this.options = b), this._setUpListeners();
    };
  ...
  (function(a) {
    function b(b) {
      return this.each(function() {
        const e = a(this);
        if (!e.data(c)) {
          const f = a.extend({}, d, e.data(), typeof b === 'object' && b);
          e.data(c, new h(e, f));
        }
      });
    }
    ...
    const f = { open: 'menu-open', tree: 'tree' };
    const g = { collapsed: 'collapsed.tree', expanded: 'expanded.tree' };
    var h = function(b, c) {
      (this.element = b),
        (this.options = c),
    ...
    (h.prototype.toggle = function(a, b) {
      const c = a.next(e.treeviewMenu);
      const d = a.parent();
      const g = d.hasClass(f.open);
      d.is(e.treeview) &&
      ...
      (h.prototype.expand = function(b, c) {
        const d = a.Event(g.expanded);
        if (this.options.accordion) {
          const h = c.siblings(e.open);
          const i = h.children(e.treeviewMenu);
          this.collapse(i, h);
        }
        c.addClass(f.open),
          b.slideDown(
  ...
  (function(a) {
    ...
    var c = 'lte.layout';
    var d = { slimscroll: !0, resetHeight: !0 };
    const e = {
      wrapper: '.wrapper',
      contentWrapper: '.content-wrapper',
    ...
    const f = { fixed: 'fixed', holdTransition: 'hold-transition' };
    var g = function(a) {
    ...
    (g.prototype.activate = function() {
      ...
      (g.prototype.fix = function() {
        ...
        const b = a(e.mainFooter).outerHeight() || 0;
        const c = a(e.mainHeader).outerHeight() || 0;
        const d = c + b;
        const g = a(window).height();
        const h = a(e.sidebar).height() || 0;
      ...
      (g.prototype.fixSidebar = function() {
        ...
        this.options.slimscroll &&
          void 0 !== a.fn.slimScroll &&
          a(e.mainSidebar).find(e.slimScrollDiv).length === 0 &&
