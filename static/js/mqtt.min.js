  ...
  return (function e(t, n, r) {
  ...
  })(
    {
        ...
        function(require, module, exports) {
          (function(process, global) {
            ...
            MqttClient.prototype._handlePublish = function(packet, done) {
              ...
              switch (qos) {
                case 2:
                  ...
                  break;
                case 1:
                  this._sendPacket({ cmd: 'puback', messageId: mid });
                case 0:
              ...
              switch (type) {
                ...
                case 'suback':
                  ...
                  if (
                    ...
                    (packet.granted[0] & 128) !== 0
                  ) {
                    const topics = this.messageIdToTopic[mid];
                    if (topics) {
            ...
            MqttClient.prototype._handlePubrel = function(packet, callback) {
              const mid = packet.messageId;
              const that = this;
              const comp = { cmd: 'pubcomp', messageId: mid };
      ...
      5: [
        function(require, module, exports) {
          ...
          function buildUrl(opts, client) {
            ...
            let url = `${protocol}://${opts.hostname}:${opts.port}${opts.path}`;
            if (typeof opts.transformWsUrl === 'function') {
              url = opts.transformWsUrl(url, opts, client);
            }
            return url;
      ...
      6: [
        ...
        { _process: 30, 'readable-stream': 44 },
      ],
      7: [
        function(require, module, exports) {
        ...
        function(require, module, exports) {
          (function(Buffer) {
            ...
            BufferList.prototype.shallowSlice = function shallowSlice(
              ...
              const buffers = this._bufs.slice(
                startOffset[0],
                endOffset[0] + 1,
              );
      ...
      40: [
        function(require, module, exports) {
          (function(process, global) {
            ...
            const util = require('core-util-is');
            util.inherits = require('inherits');
            const internalUtil = { deprecate: require('util-deprecate') };
            const Stream = require('./internal/streams/stream');
            const Buffer = require('safe-buffer').Buffer;
            const OurUint8Array = global.Uint8Array || function() {};
            function _uint8ArrayToBuffer(chunk) {
            ...
            Writable.prototype.write = function(chunk, encoding, cb) {
              ...
              let ret = false;
              const isBuf = _isUint8Array(chunk) && !state.objectMode;
      ...
      42: [
        function(require, module, exports) {
          ...
          module.exports = { destroy, undestroy };
        },
        { 'process-nextick-args': 29 },
      ],
      43: [
        ...
        function(require, module, exports) {
          (function(process, global) {
            ...
            function WebSocketStream(target, protocols, options) {
              ...
              const bufferTimeout = options.browserBufferTimeout || 1e3;
